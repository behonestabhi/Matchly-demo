 ...
 * code (controllers/services) trusts this context; this service does <em>not</em>
 * re-verify the JWT. When headers are absent (e.g. local Swagger calls) the
 * context is simply left unset and per-endpoint resolution decides what to do.
 */
@Component
@Order(0)
